...
public class MainActivity extends FragmentActivity {
	...
	private void updateProfile(Player player){
		...
		String playerScore = ""+player.credits;
		((SelectionFragment)fragments[SELECTION]).userNameView.setText(player.userName + "\nPlayer Score: " + playerScore);
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    mHandler = new Handler(){
	    	...
	    	public void handleMessage(Message message){
	    		if(message.arg1 == PlayerSession.MESSAGE_LOGON_SUCCESS){
	    			MainActivity.this.updateProfile((Player) message.obj);
	    		}else if(message.arg1 == PlayerSession.MESSAGE_START_GAME){
	    			Intent intent = new Intent(MainActivity.this,GameActivity.class);
	    			startActivity(intent);
	    		}else{
	    			System.err.println("Unidentified message!!!!!!!!!!!!");
	    		}
	    	}
	    };
